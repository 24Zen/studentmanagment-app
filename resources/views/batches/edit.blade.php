...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('batches/' .$batches->id) }}" method="post">
        ...
        <input type="text" name="start_date" id="syllabus" value="{{$batches->course->name}}" class="form-control"></br>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ url('batches/' . $batches->id) }}" method="post">
            ...
            <input  type="text" name="start_date" id="syllabus"  value="{{$batches->course->name}}" class="form-control"><br>
            <label>Start Date</label><br>
            <input type="date" name="start_date" id="duration" value="{{$batches->start_date}}"  class="form-control"><br>
            <!--<input type="submit" value="Update" class="btn btn-success"><br>-->
