...
/* ปุ่ม Save */
    ...
    <form class="mt-4 mt-md-0" action="{{ url('enrollments') }}" method="post">
        @csrf
        ...
        <!-- เพิ่มปุ่ม Save และให้เป็นปุ่ม submit -->
        <button type="submit" class="bubbly-button" style="float: right;">SAVE</button>
    </form>
</div>
