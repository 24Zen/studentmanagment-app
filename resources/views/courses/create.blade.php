    ...
    <div class="container mt-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-5 offset-md-1">
                <form class="mt-4 mt-md-0" form action="{{ url('courses') }}" method="post">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        <label for="surname">Syllabus</label>
                        <input type="text" name="syllabus" id="syllabus" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="email">Duration</label>
                        <input type="text" name="duration" id="duration" class="form-control"> </br></br>
